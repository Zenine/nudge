...
- Verification script：`scripts/verify.sh` 覆盖测试、compile、CLI smoke、i18n drift、VitePress build 和只读文档审计。
...
该脚本会运行公开测试套件、Python compile 检查、CLI smoke checks、i18n drift 检查、VitePress 文档构建和只读文档审计。开发时也可以运行聚焦检查：
